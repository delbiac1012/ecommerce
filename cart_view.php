	  ...
	  <div class="content-wrapper">
	    <div class="container">
	      ...
	      <section class="content">
	        <div class="row">
	        	<div class="col-sm-9">
	        		<h1 style="display: inline;" class="page-header">Seu Carrinho</h1>
	        		<form style="display: inline; margin-left: 655px;" method="POST" class="form-inline" target="_blank" action="print_cart.php">
